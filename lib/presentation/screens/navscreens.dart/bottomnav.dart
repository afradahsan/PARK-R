...
class _BottomNavState extends State<BottomNav> {
  ...
  child: BottomNavigationBar(
    ...
    backgroundColor: darkbgColor, // Set the color to darkbgColor
    items: [
      BottomNavigationBarItem(
        icon: selectedIndex == 0
            ? Image.asset('assets/Home-filled.png', height: 30,)
            : Image.asset('assets/Home-outline.png', height: 30),
        label: '',
      ),
      BottomNavigationBarItem(
        icon: selectedIndex == 1
            ? Image.asset('assets/ticket-filled.png', height: 28,)
            : Image.asset('assets/ticket-outlined.png', height: 28),
        label: '',
      ),
      BottomNavigationBarItem(
        icon: selectedIndex == 2
            ? Image.asset('assets/profile-filled.png', height: 32,)
