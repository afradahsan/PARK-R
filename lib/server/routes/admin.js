...
adminRouter.post('/admin/add-parking', admin, async (req, res) => {
  try {
    ...
    const { image, parkingName, locationName, position, carparkingFee, bikeparkingFee, truckparkingFee, carwashFee, totalSpots, indoor, carWash, evCharge, approved } = req.body;
